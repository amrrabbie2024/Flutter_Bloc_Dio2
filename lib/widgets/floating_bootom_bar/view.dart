...
class MyFloatingBottomBar extends StatefulWidget {
  const MyFloatingBottomBar({super.key});

  @override
  State<MyFloatingBottomBar> createState() => _MyFloatingBottomBarState();
}



class _MyFloatingBottomBarState extends State<MyFloatingBottomBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Floating bottom bar"),
