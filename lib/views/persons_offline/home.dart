...
import 'searchperson.dart';

class PersonsHome_Offline extends StatefulWidget {
  const PersonsHome_Offline({Key? key}) : super(key: key);

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PersonsHome_Offline> with TickerProviderStateMixin {
  var _tabcontroller;
  var intial_index=0;
