...
class UpdateProductView extends StatefulWidget {
  ...
  const UpdateProductView({super.key, required this.data});
...
final ggggbloc=GetIt.I<UpdateProductBloc>();
...
class _UpdateProductViewState extends State<UpdateProductView> {
  ...
  void initState() {
    ...
    currentCategory=widget.data.category;
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Edit product",style: TextStyle(color: Theme.of(context).primaryColor,fontSize: 24,fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
              ...
              BlocConsumer(
                ...
                listener: (context, state) {
                  if(state is UpdateProductFailedState)
                    ...
                    showMessage("Product with id ${state.data.id} update sucessfully",isSucess: true);
                },
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
          ...
          onPressed: () {
            ...
            //kkkbloc.add(postAddProductEvent(title: titleController.text, description: descController.text, image: imageController.text, category: currentCategory!,price: priceController.text));
            ggggbloc.add(putUpdateProductEvent(title: titleController.text, price: priceController.text, description: descController.text, image: imageController.text, category: currentCategory!, id: widget.data.id));
            // }
          }, child: Text("Update product ...",style: TextStyle(color:  Theme.of(context).primaryColor,fontSize: 21,fontWeight: FontWeight.w500),)),
    );
  }
